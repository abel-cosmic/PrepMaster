    ...
    return (
        <div className="w-full flex flex-col justify-between pt-10 pb-2 footer-new mt-20" style={{ height: "30rem" }}>
            <div className="px-12 flex flex-row justify-between mr-8">
                ...
                <div className="flex flex-row justify-between" style={{ width: "35rem" }}>
                    {lists.map((list) => (
                        <div className="flex flex-col justify-between login" key={list.id}>
                            <div className="font-medium text-white text-lg login linked">{list.list1}</div>
                            <div className="text-white text-base login linked">{list.list2}</div>
                            <div className="text-white text-base login linked">{list.list3}</div>
                            <div className="text-white text-base login linked">{list.list4}</div>
                        </div>
                    ))}
                </div>
